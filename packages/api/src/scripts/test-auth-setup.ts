...
async function testAuthSetup() {
  ...
  try {
    ...
    const customerReqs = VerificationService.getVerificationRequirements('customer');
    const driverReqs = VerificationService.getVerificationRequirements('driver');
    const vendorReqs = VerificationService.getVerificationRequirements('vendor');
