...
import type { UserSettings, UserRole, SettingsErrorType } from '../../types/settings';
...
describe('SettingsManager', () => {
  ...
  const mockRole: UserRole = 'shopper';
  ...
  describe('getUserSettings', () => {
    ...
    it('should throw error for invalid input', async () => {
      ...
      await expect(settingsManager.getUserSettings(mockUserId, '' as UserRole))
        .rejects.toThrow('User ID and role are required');
    });
  });
  ...
  describe('retry logic', () => {
    it('should retry on retryable errors', async () => {
      const retryableError = {
        type: 'NETWORK_ERROR' as SettingsErrorType,
    ...
    it('should not retry on validation errors', async () => {
      const validationError = {
        type: 'VALIDATION_ERROR' as SettingsErrorType,
