...
export type { DocumentData, QuerySnapshot, DocumentSnapshot, Timestamp, } from 'firebase/firestore';
export type { StorageReference, UploadTask, } from 'firebase/storage';
