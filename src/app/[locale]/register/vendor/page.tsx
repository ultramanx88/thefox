    ...
    <div className="container mx-auto px-4 py-8 flex items-center justify-center min-h-[calc(100vh-8rem)]">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="font-headline text-3xl">Become a Vendor</CardTitle>
          <CardDescription>
            Set up your shop and start selling on TaladMan today.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="storeName" placeholder="e.g., Green Farms" />
            </div>
            <div className="space-y-2">
