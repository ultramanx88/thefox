...
import type { Payload as RechartsTooltipPayload, ValueType, NameType } from "recharts/types/component/DefaultTooltipContent";
...
interface ChartTooltipContentProps extends React.ComponentProps<"div"> {
  ...
  label?: string | number;
  labelFormatter?: (label: any, payload: ReadonlyArray<RechartsTooltipPayload<ValueType, NameType>>) => React.ReactNode;
  labelClassName?: string;
  formatter?: (
    value: ValueType,
    name: NameType,
    item: RechartsTooltipPayload<ValueType, NameType>,
    index: number,
